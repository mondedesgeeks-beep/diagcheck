...
function computeDiagsParticulier(a) {
  ...
  if (isLocal) {
    ...
    if (isVente) diags.push({ id: "CARREZ", label: "Loi Carrez", full: "Mesurage Loi Carrez", icon: "📐", color: BLUE, scope: "Local", duree_mois: null, duree_label: "Illimité sauf travaux", desc: "Vente uniquement." });
    return diags;
  }
...
.logo-name{font-family:'Raleway',sans-serif;font-size:18px;font-weight:800;color:#1B3A8C;letter-spacing:-0.5px;line-height:1.1}
.logo-sub{font-family:'Nunito',sans-serif;font-size:9px;font-weight:600;color:#94a3b8;letter-spacing:0.5px;margin-top:1px;text-transform:uppercase}
...
// ═══════════════════════════════════════════════════════════════════
// AdrienConfetti — Animation confettis "Créé par Adrien"
// Se déclenche quand on tape "ADRIEN" dans le champ code agence
// ═══════════════════════════════════════════════════════════════════
function AdrienConfetti({ onClose }) {
  const confettis = useMemo(function() {
    var arr = [];
    var colors = ["#1B3A8C", "#6AB023", "#FCD34D", "#EF4444", "#8B5CF6", "#EC4899"];
    for (var i = 0; i < 60; i++) {
      arr.push({
        id: i,
  ...
  return (
    <>
      ...
      <div style={{ position: "fixed", inset: 0, zIndex: 9998, pointerEvents: "none", overflow: "hidden", animation: "_adrFade 3s ease-out forwards", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <div style={{
          background: "linear-gradient(135deg, #1B3A8C, #6AB023)",
          color: "white",
          padding: "22px 32px",
          borderRadius: 18,
...
export default function DiagCheck() {
  ...
  const [_dc_confetti, _setDcConfetti] = useState(false); // Easter egg : confettis "Créé par Adrien"
  ...
  var handleCode = useCallback(function() {
    ...
    // Easter egg : si on tape "ADRI", déclencher l'animation confettis
    if (code === "ADRI") {
      _setDcConfetti(true);
      setCodeInput("");
      setCodeError(false);
      ...
      <div className="app" data-app-author="Adrien Ottonello" data-app-version="DC-AO-2026">
        <header className="header">
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <div className="logo-sub">par AC Environnement</div>
          </div>
        ...
        {/* Easter egg : confettis "Créé par Adrien" (taper ADRIEN dans code agence) */}
        {_dc_confetti && <AdrienConfetti onClose={function() { _setDcConfetti(false); }} />}
